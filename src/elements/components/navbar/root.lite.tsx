  ...
  const state = useStore<RootState>({
    ...
    handleClickOutside({ target }: MouseEvent) {
      if (document.body.classList.contains('nav-open')) {
        if (
          !(target as Element).classList.contains('pa-header__burger') &&
          !(target as Element).classList.contains('pa-header__burger--icon') &&
          !(target as Element).classList.contains('pa-navbar__root') &&
          !(target as Element).classList.contains('pa-navbar__item')
        ) {
